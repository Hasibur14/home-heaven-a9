...
const Estate = ({property}) => {
    ...
    const {image, estate_title,location,status,price ,area} = property;
        ...
        <div className="mt-10 mb-16">
            <div className="lg:w-[430px] rounded-lg shadow-md border-2 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="flex flex-col justify-between p-6 space-y-4">
                    ...
                    <Link to='/estateDetails' className="flex btn items-center bg-green-400 text-white  justify-center w-full p-3 font-semibold tracking-wide rounded-md">Details</Link>
                </div>
            </div>
        </div>
    );
